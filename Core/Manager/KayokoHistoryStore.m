...
static NSString *const kKayokoHistoryStoreErrorDomain = @"com.lindo.kayoko.history-store";
...
+ (NSString *)defaultDatabasePath {
    return jbroot(@"/var/mobile/Library/com.lindo.kayoko/history-v4.sqlite");
}
