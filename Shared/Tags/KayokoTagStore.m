...
NSString *const kKayokoTagStoreErrorDomain = @"com.lindo.kayoko.tag-store";

static NSString *const kKayokoTagStoreDataDirectoryPath = @"/var/mobile/Library/com.lindo.kayoko";
